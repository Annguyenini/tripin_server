...
def bootstrapping_credentials():
    ...
    AWS_ACCESS_KEY_ID = os.getenv("AWS_ACCESS_KEY_ID") or MISSING.append(
        "AWS_ACCESS_KEY_ID"
    )
    AWS_SECRET_ACCESS_KEY = os.getenv("AWS_SECRET_ACCESS_KEY") or MISSING.append(
        "AWS_SECRET_ACCESS_KEY"
    )
    AWS_DEFAULT_REGION = os.getenv("AWS_DEFAULT_REGION") or MISSING.append(
        "AWS_DEFAULT_REGION"
    )
    ...
    MAIL_DEFAULT_SENDER = os.getenv("EMAIL_DEFAULT_SENDER") or MISSING.append(
    ...
    MAPBOX_PUBLIC_KEY = os.getenv("MAPBOX_PUBLIC_KEY") or OPTIONS.append(
        "MAPBOX_PUBLIC_KEY"
    )
    ...
    DISCORD_ERROR_WEBHOOK = os.getenv("DISCORD_ERROR_WEBHOOK") or OPTIONS.append(
        "DISCORD_ERROR_WEBHOOK"
    )
    DISCORD_REQUEST_WEBHOOK = os.getenv("DISCORD_REQUEST_WEBHOOK") or OPTIONS.append(
        "DISCORD_REQUEST_WEBHOOK"
    )
    DISCORD_STATUS_WEBHOOK = os.getenv("DISCORD_STATUS_WEBHOOK") or OPTIONS.append(
