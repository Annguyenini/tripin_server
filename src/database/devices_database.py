        ...
        try:
            cur.execute(
                ...
                f"""INSERT INTO {DATABASEKEYS.TABLES.DEVICES} (
                        ...
                        DO UPDATE SET
                        {DATABASEKEYS.DEVICES.USER_ID} = EXCLUDED.{DATABASEKEYS.DEVICES.USER_ID},
                        ...
                        WHERE
                        {DATABASEKEYS.TABLES.DEVICES}.{DATABASEKEYS.DEVICES.USER_ID}
                        IS DISTINCT FROM EXCLUDED.{DATABASEKEYS.DEVICES.USER_ID}
                        OR {DATABASEKEYS.TABLES.DEVICES}.{DATABASEKEYS.DEVICES.LAST_SEEN}
